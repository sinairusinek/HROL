...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="placeName">
        <span class="place" style="color: green"><xsl:apply-templates/></span>
    </xsl:template>
    <xsl:template match="persName">
        <span class="person" style="color:blue"><xsl:apply-templates/></span>
    </xsl:template>
    ...
    <xsl:template match="signed">
        <p style="font:em; text-align:left"><xsl:apply-templates/></p>
    </xsl:template>
    <xsl:template match="salute">
        <p style="font:em; text-align:right"><xsl:apply-templates/></p>
    </xsl:template>
